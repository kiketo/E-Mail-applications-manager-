...
namespace eMAM.Service.Contracts
{
    public class GmailApiService : IGmailApiService
    {
        ...
        //    byte[] data = FromBase64ForUrlString(firstMessage.Payload.Body.Data);



        //byte[] data = FromBase64ForUrlString(firstMessage.Payload.Parts[0].Parts[0].Body.Data);

        //byte[] data = FromBase64ForUrlString(firstMessage.Payload.Parts[1].Body.Data);
